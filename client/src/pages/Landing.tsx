  ...
  <>
    ...
    <section id="features" className="py-24 relative">
      <div className="max-w-7xl mx-auto px-4 text-center">
        <h2 ref={titleRef} className="text-3xl font-bold mb-12 font-mono tracking-tighter uppercase">EVERYTHING YOU NEED</h2>
        <div ref={featuresRef} className="grid md:grid-cols-3 gap-8">
          <div className="feature-card bg-zinc-900/40 backdrop-blur-sm border border-zinc-800 rounded-2xl p-10 flex flex-col items-center justify-center hover:border-primary/50 transition-all duration-500 cursor-pointer group hover:-translate-y-2 shadow-2xl">
          ...
          <div className="feature-card bg-zinc-900/40 backdrop-blur-sm border border-zinc-800 rounded-2xl p-10 flex flex-col items-center justify-center hover:border-secondary/50 transition-all duration-500 cursor-pointer group hover:-translate-y-2 shadow-2xl">
          ...
          <div className="feature-card bg-zinc-900/40 backdrop-blur-sm border border-zinc-800 rounded-2xl p-10 flex flex-col items-center justify-center hover:border-purple-500/50 transition-all duration-500 cursor-pointer group hover:-translate-y-2 shadow-2xl">
