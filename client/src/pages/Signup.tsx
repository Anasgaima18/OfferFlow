...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { data } = await auth.signup({ name, username: username || undefined, email, password });
        ...
        <div className="w-full max-w-md">
          <div ref={formCardRef} className="glass-card p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label htmlFor="signup-username" className="block text-sm font-mono text-gray-400 mb-2">Username</label>
                <div className="relative">
