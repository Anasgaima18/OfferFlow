...
import { ArrowRight, Clock, Eye, EyeOff, Loader2, Lock, Mail, ShieldCheck, Target, Zap } from 'lucide-react';
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex overflow-hidden relative">
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_top_left,rgba(255,184,0,0.1),transparent_24%),radial-gradient(circle_at_bottom_right,rgba(20,184,166,0.12),transparent_26%)]" />
      ...
      <div ref={leftPaneRef} className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative">
        <div>
          ...
          <div className="max-w-md">
            ...
            <p className="text-gray-400 font-mono text-sm leading-relaxed mb-8">
              Step back into the command layer. Continue your prep cadence, review the misses, and start the next live session fast.
            </p>
            ...
            <div className="rounded-[1.75rem] border border-white/10 bg-white/4 p-5 mb-8 backdrop-blur-xl">
              ...
              <div className="h-2 rounded-full bg-white/8 overflow-hidden">
                <div className="h-full w-[92%] rounded-full bg-linear-to-r from-primary via-amber-300 to-secondary" />
              </div>
            </div>
        ...
        <div className="rounded-[1.75rem] border border-white/8 bg-white/3 p-5 max-w-md">
          ...
          <p className="text-gray-400 text-sm font-mono leading-relaxed">OAuth and email sign-in both drop you back into the same interview operating system with your progress intact.</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div ref={formCardRef} className="premium-panel p-8 md:p-9 rounded-[2rem] border border-white/10 bg-black/45 shadow-[0_28px_90px_rgba(0,0,0,0.4)]">
            ...
            <form ref={formRef} onSubmit={rhfHandleSubmit(onSubmit)} className="space-y-4" noValidate>
              <div className="auth-field">
                <label htmlFor="login-email" className="block text-sm font-mono text-gray-400 mb-2">Email</label>
                ...
                {errors.email && (
                  <p id="login-email-error" className="mt-1.5 text-xs text-red-400 font-mono" role="alert">
              ...
              <div className="auth-field">
                <label htmlFor="login-password" className="block text-sm font-mono text-gray-400 mb-2">Password</label>
                <div className="relative">
                ...
                {errors.password && (
                  <p id="login-password-error" className="mt-1.5 text-xs text-red-400 font-mono" role="alert">
            ...
            <div className="auth-field mt-6 flex items-center justify-between gap-3 text-xs font-mono text-gray-500">
              <span className="inline-flex items-center gap-2"><ShieldCheck size={12} /> Encrypted session access</span>
