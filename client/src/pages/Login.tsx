...
import { Target, Zap, Clock, Mail, Lock, Eye, EyeOff, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div ref={formCardRef} className="glass-card p-8">
            ...
            <div className="flex gap-4 mb-6">
              <button
                ...
                className="flex-1 py-3 rounded-lg glass hover:bg-white/10 transition-colors flex items-center justify-center group"
              >
